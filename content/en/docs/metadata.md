...
The snapshot.json metadata file lists version numbers and/or hashes of all of the targets 
metadata. This file ensures that clients will see a consistent
